...
| ------------- | ------------- |
| "docker build . -t prashantd15/accounts:s4" | To generate a docker image based on a Dockerfile |
| "docker run  -p 8080:8080 prashantd15/accounts:s4" | To start a docker container based on a given image |
| "docker images" | To list all the docker images present in the Docker server |
| "docker image inspect image-id" | To display detailed image information for a given image id |
| "docker image rm image-id" | To remove one or more images for a given image ids |
| "docker image push docker.io/prashantd15/accounts:s4" | To push an image or a repository to a registry |
| "docker image pull docker.io/prashantd15/accounts:s4" | To pull an image or a repository from a registry |
...
| ------------- | ------------- |
| "ab -n 10 -c 2 -v 3 http://localhost:8072/prashantlabs/cards/api/contact-info" | To perform load testing on API by sending 10 requests |
...
| "kubectl set image deployment gatewayserver-deployment gatewayserver=prashantd15/gatewayserver:s11 --record" | To set a new image for a deployment inside your cluster |
